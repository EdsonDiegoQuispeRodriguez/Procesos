 ...
 * @author edson
 */
@WebServlet(name = "PararInProcessUnplannedServlet", urlPatterns = {"/PararInProcessUnplannedServlet"})
public class PararInProcessUnplannedServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PararInProcessUnplannedServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PararInProcessUnplannedServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String valorSeleccionado = request.getParameter("unplanned");
        String nombreProceso = "";
        String tipo = "UNPLANNED DOWNTIME";
        String motivo = valorSeleccionado;
        ...
        daoProc.registrarPareNoPlaneado(proceso);
